...
const ACTIVITY = [
    { id: '1', message: 'Cabang Depok memproses 12 pesanan hari ini.', timestamp: '10 menit lalu', isActive: true },
    { id: '2', message: 'Voucher baru SUPERSALE25 aktif di seluruh cabang.', timestamp: '2 jam lalu' },
    { id: '3', message: 'Admin baru ditambahkan untuk cabang Bogor.', timestamp: 'Kemarin' },
];

export default function SuperadminDashboardPage() {
    const pengguna = getCachedPengguna();
    const displayName = pengguna?.nama ?? 'Superadmin';

    return (
        <div className="flex flex-col gap-[50px]">
            <DashboardHeader name={displayName} activeVouchers={0} membership="Superadmin" />
            <StatsGrid activeOrders={8} completedOrders={210} totalSaved="$1,240.00" />
